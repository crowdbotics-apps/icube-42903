"""
Django settings for icube_42903 project.
...
WSGI_APPLICATION = 'icube_42903.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "icube_42903 API",
    "DESCRIPTION": "API documentation for icube_42903 App",
    "VERSION": "v1",
}
